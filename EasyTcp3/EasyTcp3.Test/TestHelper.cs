...
namespace EasyTcp3.Test
{
    public static class TestHelper
    {
        ...
        /// <summary>
        /// Wait until default timeout expires, but cancel if passed function returns true
        /// </summary>
        /// <param name="d"></param>
        ...
        /// <summary>
        /// Wait until default timeout expires, but cancel if passed function returns false
        /// </summary>
        /// <param name="d"></param>
