...
namespace EasyTcp4.Actions.Utils.Async
{
    public static class SendActionAndGetReplyAsyncUtil
    {
        ...
        /// <param name="compression">compress data using deflate if set to true</param>
        /// <returns>received reply</returns> 
        public static async Task<Message> SendActionAndGetReplyAsync(this EasyTcpClient client, string action, byte[] data = null,
                TimeSpan? timeout = null, bool compression = false) =>
        ...
        public static async Task<Message> SendActionAndGetReplyAsync(this EasyTcpClient client, int action, string data,
            ...
            => await client.SendActionAndGetReplyAsync(action, (encoding ?? Encoding.UTF8).GetBytes(data), timeout, compression);
        ...
        /// <param name="compression">compress data using deflate if set to true</param>
        /// <returns>received reply</returns>
        public static async Task<Message> SendActionAndGetReplyAsync(this EasyTcpClient client, int action, IEasyPacket data,
                TimeSpan? timeout = null, bool compression = false)
